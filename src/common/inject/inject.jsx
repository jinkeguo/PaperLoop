...
if (isTopWindow) {
	...
	Zotero.Messaging.addMessageListener("paperloop.sidebar.update", function (props) {
		return Zotero.PaperLoopSidebar.update(props);
	});
	Zotero.Messaging.addMessageListener("paperloop.sidebar.status", function () {

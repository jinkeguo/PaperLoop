...
window.Zotero={getMainWindow:()=>window,logError:e=>fixture.notices.push({error:e.message}),debug(){},Notes:{AUTO_SYNC_DELAY:1},
 ...
 async paperLoopGetDocumentState(){return {status:linked?'existing':'missing',...await PaperLoopNotebook.snapshot(parent,note)};},

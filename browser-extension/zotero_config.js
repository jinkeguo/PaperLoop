...
const ZOTERO_CONFIG = {
	...
	// PaperLoop has its own product version (for example 0.3.13), which is not
	// a Zotero Connector compatibility version. Keep repository/API negotiation
	// on the current upstream Connector compatibility line.
	CONNECTOR_COMPATIBILITY_VERSION: '4.999.0',
	...
	GOOGLE_DOCS_API_URL: "https://script.googleapis.com/v1/scripts/AKfycbwWSWNnwB-8otbBPAD7j84fBOFnditdwmauqC0-yrZYdCKOTxif7L0TLZ8TkpGRrE1xaw:run",
	OAUTH: {
		ZOTERO: {

...
var MESSAGES = {
	...
	Connector_Browser: {
		...
		paperLoopSaveThought: true,
		paperLoopNotebook: true,
		paperLoopGetCollections: true,
		paperLoopGetDocumentState: true,
		paperLoopSetTarget: true,
		paperLoopAppendThought: true,
		paperLoopSetPinned: true,
		paperLoopSetMinimized: true,
		paperLoopSetAutoDisplayCategories: true,
		paperLoopSetAutoOpen: true,
		paperLoopSetPosition: true,

...
Zotero.UI.ModalPrompt = class ModalPrompt extends React.Component {
  ...
  render() {
    ...
    if (this.props.input) {
      let inputControl = this.props.inputMultiline ? React.createElement("textarea", {
      ...
      input = React.createElement("p", {
        className: "input"
      }, React.createElement("label", null, inputControl));
    }
    for (let i = 1; i <= 3; i++) {
    ...
    return React.createElement("div", {
      className: `ModalPrompt-overlay${dockedClass}`,
      onClick: onClickOutside
    }, React.createElement("div", {
      className: `ModalPrompt${dockedClass}`,
      role: "dialog",
